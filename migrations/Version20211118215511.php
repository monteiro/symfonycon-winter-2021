 ...
 */
final class Version20211118215511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car_match (id VARCHAR(36) NOT NULL, reservation_id VARCHAR(36) DEFAULT NULL, car_id VARCHAR(36) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE customer (id VARCHAR(36) NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE stored_event (id VARCHAR(32) NOT NULL, type_name VARCHAR(255) NOT NULL, event_body VARCHAR(255) NOT NULL, aggregate_root_id VARCHAR(255) NOT NULL, actor_id VARCHAR(32) NOT NULL, published BOOLEAN NOT NULL, occurred_on DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
